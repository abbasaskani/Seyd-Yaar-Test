...
def main() -> None:
    ...
    if args.cmd == "demo-generate":
        ...
        aoi = _json.loads((repo_root / "backend" / "config" / "aoi.geojson").read_text(encoding="utf-8"))
        species_profiles = _json.loads((repo_root / "backend" / "config" / "species_profiles.json").read_text(encoding="utf-8"))
